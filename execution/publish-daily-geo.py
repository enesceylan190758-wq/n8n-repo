...
JSON (tek nesne):
{{
  "direct_answer": "40-60 kelime doğrudan cevap",
  "bullets": ["madde1", "madde2", "madde3"],
  "faq": [{{"q": "soru", "a": "cevap"}}, {{"q": "...", "a": "..."}}, {{"q": "...", "a": "..."}}],
  "internal_links": ["{SITE}{path}", "{SITE}/blog"],
  "linkedin_one_liner": "LinkedIn için 1 cümle (max 220 karakter)"
}}

Kurallar:
- Tıbbi iddia/garanti yok
- direct_answer filler olmadan başlasın
- faq tam 3 madde
- bullets 3-5 kısa madde
"""
    try:
        out = vertex_json(
            prompt,
            system="Sen Nefalix GEO editörüsün. Yalnızca geçerli JSON döndür.",
