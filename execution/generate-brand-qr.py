...
PRESETS = {
    ...
    "whatsapp": "https://wa.me/905491190819?text=Merhaba%2C%20Nefalix%20hakkında%20bilgi%20almak%20istiyorum.",
...
def main() -> None:
    ...
    parser.add_argument("--preset", choices=list(PRESETS), default="site")
