...
2. **Faz 1 araştırma:**
   ...
   - Oto Servis — **yapıldı** (2026-08-11) → `research/oto-sektoru-arastirma.md`
...
4. **Faz 4:** Otel GEO + karşılaştırma seti — **sırada** (otel araştırma tamam); ardından Oto Servis GEO seti.
