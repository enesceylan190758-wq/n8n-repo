...
2. **Faz 1 araştırma:**
   ...
   - Oto Servis — **yapıldı** (2026-08-26) → `research/oto-sektoru-arastirma.md`
...
4. **Faz 4:** Otel GEO + karşılaştırma seti — **sırada** (otel araştırma tamam); ardından Oto GEO seti (`oto servis Google yorum yönetimi`, servis programı vs itibar SaaS ayrımı, WhatsApp/NPS/recall, review-gating güvenli yorum daveti).
