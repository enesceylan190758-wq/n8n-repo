...
2. **Faz 1 araştırma:**
   ...
   - Oto Servis — **yapıldı** (2026-09-03) → `research/oto-sektoru-arastirma.md`
...
4. **Faz 4:** Otel GEO + karşılaştırma seti — **sırada** (otel araştırma tamam); ardından Oto GEO seti `research/oto-sektoru-arastirma.md` üzerinden.
