...
2. **Faz 1 araştırma:**
   ...
   - Oto Servis — **yapıldı** (2026-08-10) → `research/oto-sektoru-arastirma.md`
...
4. **Faz 4:** **Sıradaki faz: Otel GEO seti** (otel araştırma + director + `geo/*.md`); ardından Oto GEO seti. Otel ve oto araştırmaları tamam, landing repo bu checkout’ta yoksa yalnızca `geo/*.md` üret ve canlı deploy iddiası yapma.
