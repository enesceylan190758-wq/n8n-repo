...
2. **Faz 1 araştırma:**
   ...
   - Oto Servis — **yapıldı** (2026-09-01) → `research/oto-sektoru-arastirma.md`
...
4. **Faz 4:** Otel GEO + karşılaştırma seti — **sıradaki ana faz** (otel araştırma tamam); ardından oto GEO seti `research/oto-sektoru-arastirma.md` üzerinden ilerler.
