...
2. **Faz 1 araştırma:**
   ...
   - Oto Servis — **yapıldı** (2026-07-31) → `research/oto-sektoru-arastirma.md`
...
4. **Faz 4:** Otel (+ sonra Oto) GEO + karşılaştırma seti — **sırada** (üç sektör araştırması tamam; önce otel GEO seti).
