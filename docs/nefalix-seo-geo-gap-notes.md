...
2. **Faz 1 araştırma:**
   ...
   - Oto Servis — **yapıldı** (2026-08-19) → `research/oto-sektoru-arastirma.md`
...
4. **Faz 4:** Otel (+ sonra Oto) GEO + karşılaştırma seti — **sırada** (otel ve oto araştırmaları tamam; önce otel GEO seti).
